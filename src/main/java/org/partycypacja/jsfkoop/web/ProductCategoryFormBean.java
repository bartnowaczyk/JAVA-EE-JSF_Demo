...
@SessionScoped
@Named("itemFormCatBean")
public class ProductCategoryFormBean implements Serializable {
	...
	public ListDataModel<Produkt> getAllProducts() {
		produkty.setWrappedData(pm.getAllProducts());
		return produkty;
	}
